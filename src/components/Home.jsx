    ...
    <div id="#home" className="flex">
      <div className="flex flex-col md:ml-14 ml-10 mt-64">
        ...
        <div className="text-indigo-600 text-2xl flex px-2 gap-5 py-10 ">
         <a  href="https://github.com/"><BsGithub  className="cursor-pointer "/></a> 
          <a href="https://www.linkedin.com/in/tijil-agrawal-21165b21a/"><BsLinkedin className="cursor-pointer" /></a>
          <a href="https://www.youtube.com/channel/UC-BQdiPl1XQFxdzq63S4v6Q"><BsYoutube className="cursor-pointer" /></a>
        </div>
      </div>
